...
import 'package:plantholic/myGarden/Modelo/my_plants_model.dart';
...
class MyPlantsController  {
  ...
  Future handleShowModal(BuildContext context, MyPlant plant) {
    return showDialog(
      context: context,
  ...
  bool checkPlantAlreadyExists(MyPlant plant) {
    try {
      myPlants.firstWhere(
  ...
  void handleAddNewPlant(MyPlant plant, DateTime remember) {
  ...
  void handleRemovePlant(String plantId) {
  ...
  String handleWateringPlantTime() {
    ...
    return 'Regue sua ${myPlants[0].plant.nickname} daqui a ${hourDifference != 0 ? '$hourDifference horas' : '$minuteDifference minutos'}';
  }
}
