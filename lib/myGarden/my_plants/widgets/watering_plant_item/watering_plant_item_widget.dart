...
class WateringPlantItemWidget extends StatefulWidget {
  WateringPlantItemWidget({Key key}) : super(key: key);

  @override
  State<WateringPlantItemWidget> createState() => _WateringPlantItemWidgetState();
}

class _WateringPlantItemWidgetState extends State<WateringPlantItemWidget> {
  @override
        ...
        ? Center(
            child: Column(
              ...
              children: [
                ...
                Text('no plant found', style: AppTextStyles.bodyDark),
              ],
            ),
          )
        : ListView.builder(
